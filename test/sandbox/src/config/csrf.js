 ...
 *
 * When enabled, all non-GET requests to the App.server must be accompanied by
 * a special token, identified as the '_csrf' parameter.
 *
 * This option protects your App.app against cross-site request forgery (or CSRF) attacks.
 ...
 * http://App.s.org/#!/documentation/reference/App.config/App.config.csrf.html
 *
 */
