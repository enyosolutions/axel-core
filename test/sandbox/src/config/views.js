 ...
 * http://App.s.org/#!/documentation/concepts/Views
 */
module.exports.views = {
   ...
   * views                                                                     *
   *                                                                           *
   * App.Express supports all view engines which implement TJ Holowaychuk's  *
   ...
   * https://github.com/balderdashy/App.wiki/blob/0.9/config.views.md#engine *
   *                                                                           *
   *************************************************************************** */
   ...
   * advantage of App. built-in `layout` support.                            *
   *                                                                           *
   ...
   *                                                                           *
   * If you're using the default `ejs` or `handlebars` App.supports the use  *
   ...
   * advantage of App. built-in `partials` support.                          *
   *                                                                           *
