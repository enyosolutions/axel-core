...
(function (factory) {
  ...
  var DataTable = function (options) {
    ...
    this.each(function () {
      ...
      let i = 0; let iLen; let j; let jLen; let k; let
        kLen;
  ...
  function _fnColumnTypes(settings) {
    ...
    let i; let ien; let j; let jen; let k; let
      ken;
    let col; let cell; let detectedType; let
      cache;
  ...
  function _fnApplyColumnDefs(oSettings, aoColDefs, aoCols, fn) {
    let i; let iLen; let j; let jLen; let k; let kLen; let
      def;
  ...
  function _fnGetObjectDataFn(mSource) {
    if ($.isPlainObject(mSource)) {
      ...
      var fetchData = function (data, type, src) {
        let arrayNotation; let funcNotation; let out; let
          innerSrc;
  ...
  function _fnSetObjectDataFn(mSource) {
    if ($.isPlainObject(mSource)) {
      ...
      var setData = function (data, val, src) {
        const a = _fnSplitObjNotation(src); let
          b;
        const aLast = a[a.length - 1];
        let arrayNotation; let funcNotation; let o; let
          innerSrc;
  ...
  function _fnBuildHead(oSettings) {
    let i; let ien; let cell; let row; let
      column;
  ...
  function _fnDrawHead(oSettings, aoSource, bIncludeHidden) {
    let i; let iLen; let j; let jLen; let k; let kLen; let n; let
      nLocalTr;
    const aoLocal = [];
    const aApplied = [];
  ...
  function _fnAddOptionsHtml(oSettings) {
    ...
    let featureNode; let cOption; let nNewNode; let cNext; let sAttr; let
      j;
  ...
  function _fnDetectHeader(aLayout, nThead) {
    ...
    let nTr; let
      nCell;
    let i; let k; let l; let iLen; let jLen; let iColShifted; let iColumn; let iColspan; let
      iRowspan;
    let bUnique;
  ...
  function _fnFilter(settings, input, force, regex, smart, caseInsensitive) {
    ...
    let display; let invalidated; let
      i;
    const filtered = [];
  ...
  function _fnFilterData(settings) {
    const columns = settings.aoColumns;
    let column;
    let i; let j; let ien; let jen; let filterData; let cellData; let
      row;
  ...
  function _fnInitialise(settings) {
    let i; let iLen; const
      iAjaxStart = settings.iInitDisplayStart;
    const columns = settings.aoColumns; let
      column;
    const features = settings.oFeatures;
  ...
  const __setColumnVis = function (settings, column, vis) {
    ...
    const data = settings.aoData;
    let row; let cells; let i; let ien; let
      tr;
  ...
  _api_registerPlural('columns().cache()', 'column().cache()', function (type) {
    return this.iterator('column-rows', (settings, column, i, j, rows) => _pluck_order(settings.aoData, rows,
      type === 'search' ? '_aFilterData' : '_aSortData', column), 1);
  });
  ...
  const __cell_selector = function (settings, selector, opts) {
    ...
    let a; let i; let ien; let j; let o; let
      host;
  ...
  _api_register('cells()', function (rowSelector, columnSelector, opts) {
    ...
    // Row + column selector
    const columns = this.columns(columnSelector);
    const rows = this.rows(rowSelector);
    let a; let i; let ien; let j; let
      jen;

    this.iterator('table', (settings, idx) => {
      a = [];
